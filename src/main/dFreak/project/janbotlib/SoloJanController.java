...
import dFreak.project.janbotlib.exception.BoneheadException;
 ...
 * 麻雀コントローラ (ソロ)
 */
public class SoloJanController implements JanController {
     ...
     * 監視
     */
    public void watch(final List<JanPai> watchList) {
        // 未対応
    }
